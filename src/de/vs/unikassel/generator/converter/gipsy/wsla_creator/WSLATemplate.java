package de.vs.unikassel.generator.converter.gipsy.wsla_creator;
...
public class WSLATemplate {
	...
	public static final String servicedefinition = "de/vs/unikassel/generator/converter/gipsy/wsla_creator/ServiceDefinitionTemplate.wsla";

	public static final String obligations = "de/vs/unikassel/generator/converter/gipsy/wsla_creator/ObligationsTemplate.wsla";
	...
	protected String slaparameternameserviceconstraint;
	
	protected String sloparameternameserviceconstraint;

	public String getSloparameternameserviceconstraint() {
		return sloparameternameserviceconstraint;
	}

	public void setSloparameternameserviceconstraint(String sloparameternameserviceconstraint) {
		this.sloparameternameserviceconstraint = sloparameternameserviceconstraint;
	}

	protected String constraints;
	
	public String getSlaparameternameserviceconstraint() {
		return slaparameternameserviceconstraint;
	}

	public void setSlaparameternameserviceconstraint(String slaparameternameserviceconstraint) {
		this.slaparameternameserviceconstraint = slaparameternameserviceconstraint;
	}
	...
	public Document fillServiceDefinition() {
		...
		//Set Slaparameternames (1) Response Time (2) Throughput // (3)--> |Constraints // TODO:Must be a choice not liability.
		...
		elem = (Element) elems.item(2);

		nameattribute = elem.getAttributeNode("name");

		nameattribute.setNodeValue(this.getSlaparameternameserviceconstraint());
	...
	public void extractServiceDefinition(final Document doc) {
		...
		this.setSlaparameternameserviceconstraint(nameattribute.getNodeValue());
	}
	...
	public Document fillObligations() {
		...
		Element constraint = (Element) elems.item(2);
		...
		childs = constraint.getChildNodes();

		Node constraintValue = childs.item(0);

		//System.out.println(throughput.getLocalName());
		//System.out.println(throughputvalue.getNodeValue());
		constraintValue.setNodeValue(this.getConstraints());
		...
		nameattribute.setNodeValue(this.getSloparameternameserviceconstraint());
		...
		constraint = (Element) elems.item(2);
		...
		constraintValue = childs.item(0);

		//System.out.println(throughput.getLocalName());
		//System.out.println(throughputvalue.getNodeValue());
		constraintValue.setNodeValue(this.getSlaparameternameserviceconstraint());
